...
**התאוששות אוטומטית:** נפילה → reconnect חכם (ממתין בסשן 428 כדי לא להיבעט שוב).  
Keep-alive כל 3 דק׳; reconnect רק אחרי 3 כשלונות רצופים.  
תהליך תקוע → supervisor מרים מחדש.  
**בדיקה שעתית** שקטה. שני המספרים בקבוצה יכולים לכתוב.  
לא צריך לבקש הפעלה ידנית אחרי כל נפילה.
