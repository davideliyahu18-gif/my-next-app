...
| מקור | יעד |
|------|-----|
| טלגרם [`@newsil5`](https://t.me/newsil5) | וואטסאפ **חמ״ל התרעות ירי איראן 🛡️** (מודגש) |

השם «מודיעין גלוי» לא מוצג בהודעות — רק כותרת החמ״ל במודגש.
...
TG_WA_CHANNELS=newsil5:ערוץ מקור
TG_WA_WHATSAPP_GROUP_NAME=חמ״ל התרעות ירי איראן 🛡️

GREEN_API_INSTANCE=...
GREEN_API_TOKEN=...
TG_WA_WHATSAPP_CHAT_ID=120363410746391414@g.us
TG_WA_WHATSAPP_CHAT_IDS=120363410746391414@g.us
...
1. חבר ב-Green API את **אותו וואטסאפ** שחבר בקבוצה «חמ״ל התרעות ירי איראן»
2. אחרי Deploy:
